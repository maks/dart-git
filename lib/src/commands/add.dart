...
class Add {
   ...
   */
  static Future<FileStatus> addEntry(GitOptions options, Entry entry) {
   ...
   */
  static Future _addEntries(
      GitOptions options, List<Entry> entries, List<FileStatus> statuses) {
   ...
   */
  static Future<List<FileStatus>> addEntries(
      GitOptions options, List<Entry> entries) {
